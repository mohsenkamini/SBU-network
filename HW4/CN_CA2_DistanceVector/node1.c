...
void printdt1() {
    ...
    printf("   D0 |    1     2    3 \n");
    printf("------|-----------------\n");
    printf("     1|  %3d   %3d   %3d\n", dt1.costs[1][1], dt1.costs[1][2], dt1.costs[1][3]);
    printf("dest 2|  %3d   %3d   %3d\n", dt1.costs[2][1], dt1.costs[2][2], dt1.costs[2][3]);
    printf("     3|  %3d   %3d   %3d\n", dt1.costs[3][1], dt1.costs[3][2], dt1.costs[3][3]);
    printf("------------------------\n");
}
